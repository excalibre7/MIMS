...
const ActiveMaintainence = (props) => {
...
const RenderSD = memo( (params) => {
  return (
        <span className="my-renderer">
            <div style={{justifyContent:"center",textAlign:"right"}}>{ params.data.START_DATE}</div>
        </span>
  );
});
...
const columnDefs = useMemo( ()=> [
  ...
  {field:"BRAND",headerName:"Brand",width:width*.1,filter:true},
  {field:"LOCATION",headerName:"Location",width:width*.1,filter:true},
  {field:"LAST_DATE",headerName:"Last Date",width:width*.14,filter:true,headerClass: "ag-right-aligned-header", cellRendererFramework: RenderLD} ,
  {field:"FREQUENCY",headerName:"Frequency",width:width*.12,filter:true,headerClass: "ag-right-aligned-header", cellRendererFramework: RenderF} ,
  {field:"START_DATE",headerName:"Maintainence Date",width:width*.12,filter:true,headerClass: "ag-right-aligned-header", cellRendererFramework: RenderSD} ,
  {field:"MECHANIC",headerName:"Mechanic",width:width*.14,filter:true,headerClass: "ag-right-aligned-header", cellRendererFramework: RenderM} ,
], []);
...
export default ActiveMaintainence;
